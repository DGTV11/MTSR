...
EXPANSION_PROMPT = "Generate ONE and ONLY ONE reasoning step that will aid you in responding to the query BASED on the query and the previous reasoning step(s) if any. That reasoning step MUST be numbered from 1 upwards depending on how many previous steps there are."
